...
1. **Angriffssimulationen (TTPs):** Kontrollierte Ausführung von Angriffen
   (z.B. mit Atomic Red Team) zur Generierung realitätsnaher Log-Daten.
2. **Custom Detection Rules:** Selbstgeschriebene Alerts zur Erkennung
   von Anomalien sowie Auswertung von Windows Event Logs.

## Hinweis zur Struktur
Dieser Ordner bietet lediglich die Einleitung. Die detaillierten
Analysereporte, extrahierten Artefakte (IOCs) und der Code für
die Detection Rules befinden sich in den jeweiligen Unterordnern
